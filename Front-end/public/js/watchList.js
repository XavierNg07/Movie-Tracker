const movieList = document.querySelector("#movielist_container");
...
/**
 * Deletes the movie from the watch list
 * @param {*} id string movie id
 */
DELETEMovie = (id) => {
    fetch(REQUEST_INFO.serverURL + ENDPOINT_KEY.watchList + "/" + id, {
